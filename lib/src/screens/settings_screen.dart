          ...
          FutureBuilder<Map<String?, List<Map<String, dynamic>>>>(
            ...
            builder: (context, snapshot) {
               ...
               if (snapshot.hasError) {
                  return ListTile(leading: Icon(Icons.error, color: const Color.fromRGBO(10, 96, 66, 1)), title: Text('Error cargando empleados: ${snapshot.error}'));
               }
                       ...
                       return ListTile(
                         ...
                         trailing: Row(
                           ...
                           children: [
                             ...
                             IconButton(
                               icon: const Icon(Icons.delete, color: Color.fromRGBO(10, 96, 66, 1)),

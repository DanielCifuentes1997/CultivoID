        ...
        if (faces.isNotEmpty) {
          ...
          if (angleY != null &&
            ...
            if (match != null && match.id != _lastDetectedId && mounted) {
              ...
              print(
                  "EmergencyScan: Rostro identificado: ${match.name}. Mostrando panel.");
      ...
      body: FutureBuilder<void>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError ||
            ...
            return const Center(
                child: Text(
                    'Error al iniciar cámara trasera. Verifique permisos.'));
          }
...
class _EmergencyInfoTile extends StatelessWidget {
  const _EmergencyInfoTile(
      {required this.icon, required this.title, this.value});
